...
```bash
curl "https://metalink-api.fly.dev/v1/metadata?url=https://example.com" \
...
```bash
curl "https://metalink-api.fly.dev/v1/metadata?url=https://example.com&api_key=ml_live_YOUR_KEY_HERE"
```
...
1. Sign in at the [Dashboard](https://web-ashy-kappa-57.vercel.app/auth/login)
