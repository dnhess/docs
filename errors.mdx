...
<AccordionGroup>
  ...
  <Accordion title="401 — Invalid API key">
    ...
    - Verify the key is still active in your [Dashboard](https://web-ashy-kappa-57.vercel.app/dashboard)
  </Accordion>
  ...
  <Accordion title="429 — Rate limit exceeded">
    ...
    - Consider [upgrading your plan](https://web-ashy-kappa-57.vercel.app/dashboard) for higher limits
  </Accordion>
